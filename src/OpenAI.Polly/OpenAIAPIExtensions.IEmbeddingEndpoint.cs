...
public static partial class OpenAIAPIExtensions
{
    ...
    /// <returns>A task that represents the asynchronous operation.</returns>
    public static Task<TResult> WithRetry<TResult>(this IEmbeddingEndpoint endpoint, Func<IEmbeddingEndpoint, CancellationToken, Task<TResult>> func, CancellationToken cancellationToken)
    {
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>A task that represents the asynchronous operation.</returns>
    public static Task WithRetry(this IEmbeddingEndpoint endpoint, Func<IEmbeddingEndpoint, CancellationToken, Task> func, CancellationToken cancellationToken)
    {
        return AsyncRetryPolicy.ExecuteAsync(ct => func(endpoint, ct), cancellationToken);
    }
